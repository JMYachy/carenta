...
class UserBuildercardListedcarmodel extends StatelessWidget {
  ...
  const UserBuildercardListedcarmodel({
    super.key,
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            // Car image with proper aspect ratio
            ClipRRect(
